    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
            ...
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/products*") ? "c-show" : "" }} {{ request()->is("admin/maps*") ? "c-show" : "" }} {{ request()->is("admin/push-notifications*") ? "c-show" : "" }}">
                ...
                <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.suppliers.index") }}" class="c-sidebar-nav-link {{ request()->is("/suppliers") || request()->is("/suppliers/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-user c-sidebar-nav-icon">
                                </i>
                                Suppliers
                            </a>
                ...
                <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.locations.index") }}" class="c-sidebar-nav-link {{ request()->is("/locations") || request()->is("/locations/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-user c-sidebar-nav-icon">
                    ...
                    @endcan
                    <!-- @can('efriscategoryproduct_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.efrisgoodsategory.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/efrisproductcategory") || request()->is("admin/efrisproductcategory/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-product-hunt c-sidebar-nav-icon">

                                </i>
                                Efris Product Category
                            </a>
                        </li>
                    @endcan -->
                     @can('product_access')
