...
@can('role_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
        <b style="color:black;font-size:25px;">Detailed Stock Hold</b>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
    <form method="post" class="row" action="{{route('admin.detailedstock.searchhold')}}">
                    @csrf
                    <div class="col-4">
