...
<div class="card">
  ...
  <div class="form-row">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-striped table-hover datatable datatable-subd">
          <thead>
            <tr>
              <th></th>
              <th class="wd-15p">ID</th>
              <th class="wd-15p">Dealer</th>
...
<script>
  ...
  let table = $('.datatable-subd:not(.ajaxTable)').DataTable({ buttons: dtButtons })
