...
<div class="card">
  ...
  <div class="form-row">
    ...
    <div class="card-body">
        ...
        <table id="sales"  class="table table-bordered table-striped table-hover datatable datatable-van">
        <thead>
            <tr>
                <th width="10"></th>
...
<!-- <script>
  ...
  let table = $('.datatable-van:not(.ajaxTable)').DataTable({ buttons: dtButtons })
