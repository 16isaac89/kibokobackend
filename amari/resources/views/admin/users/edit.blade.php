            ...
            <form method="POST" action="{{ route('admin.users.update', [$user->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('phonenumber') ? 'is-invalid' : '' }}" type="text"
                        name="phonenumber" id="phonenumber" value="{{ old('phonenumber', $user->phonenumber) }}">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select" id="designation" name="designation">
                        ...
                        <option value="1" {{ $user->designation == 1 ? 'selected' : '' }}>Admin</option>
                        <option value="2" {{ $user->designation == 2 ? 'selected' : '' }}>Supervisor</option>
                    </select>
                </div>
                        ...
                        id="dealers" multiple>
                            ...
                            @foreach ($dealers as $dealer)
                                <option value="{{ $dealer->id }}"
                                    {{ $user->dealers->contains($dealer->id) ? 'selected' : '' }}>
                                    {{ $dealer->tradename }}</option>
                            @endforeach
