...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#received_by_customer_payments" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="received_by_customer_payments">
            @includeIf('admin.users.relationships.receivedByCustomerPayments', ['customerPayments' => $user->receivedByCustomerPayments])
        </div>
