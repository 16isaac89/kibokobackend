...
<div class="card">
	...
	<form method="post" action="{{route('admin.dispatch.store')}}">
		<div class="row my-1">
			...
			<select class="custom-select mr-sm-2" required name="dealer">
...
<table width="350px" style="margin:10px;width:850px;">
	...
	<TABLE id="dataTable" width="350px" style="margin:10px;">
        ...
        <TD><INPUT type="checkbox" name="chk"/></TD>
            ...
            <TD><INPUT type="text" style="width:100px" name="unit[]" class="form-control productunit"/></TD>
            <TD><INPUT type="text" style="width:100px" readonly name="price[]" class="form-control productprice"/></TD>
            <TD><INPUT type="text" style="width:100px" readonly name="total[]" class="form-control producttotal"/></TD>
