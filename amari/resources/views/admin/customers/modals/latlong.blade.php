...
<!-- Modal -->
<div class="modal fade" id="uploadLatLong" tabindex="-1" aria-labelledby="uploadModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.customers.importLatLong') }}" method="POST" enctype="multipart/form-data">
                @csrf
