...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.efrisSetting.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.efris-settings.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="aeskey">{{ trans('cruds.efrisSetting.fields.aeskey') }}</label>
                <input class="form-control {{ $errors->has('aeskey') ? 'is-invalid' : '' }}" type="text" name="aeskey" id="aeskey" value="{{ old('aeskey', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tin') ? 'is-invalid' : '' }}" type="text" name="tin" id="tin" value="{{ old('tin', '') }}">
                @if($errors->has('tin'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deviceno') ? 'is-invalid' : '' }}" type="text" name="deviceno" id="deviceno" value="{{ old('deviceno', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('keypath') ? 'is-invalid' : '' }}" name="keypath" id="keypath">{{ old('keypath') }}</textarea>
