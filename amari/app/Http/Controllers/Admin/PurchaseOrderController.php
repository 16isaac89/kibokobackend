...
class PurchaseOrderController extends Controller
{
   ...
   public function create(){
    ...
    $suppliers = Supplier::all();
    return view('admin.purchases.create',compact('brands','suppliers'));
   }
   ...
   // dd($purchaseorder);
    ...
    return view('admin.purchases.edit',compact('purchaseorder','brands','suppliers','products','purchaseorderid'));
   }
   public function receiveview(){
    ...
    return view('admin.purchases.receive',compact('purchaseorder','brands','suppliers','products','purchaseid'));
   }
   public function receivepost(){
    ...
    return redirect()->route('admin.purchases.index')->with('message', 'Purchase order received successfuly.');
...
return redirect()->back()->with('success', 'Purchase order successfully edited.'); 
   ...
   // dd($purchaseorder);
    return view('admin.purchases.return',compact('purchaseorder','brands','suppliers','products','purchaseid'));
   }
