...
class HomeController
{
    public function index()
    {
        ...
        $settings2 = [
            'chart_title'        => 'Bookings By Payment Method',
            'chart_type'         => 'pie',
        ...
        $settings9 = [
            'chart_title'        => 'Customer Payments',
            'chart_type'         => 'pie',
            'report_type'        => 'group_by_relationship',
            'model'              => 'App\Models\CustomerPayment',
            'group_by_field'     => 'fullname',
            ...
            'translation_key'    => 'customerPayment',
        ];

        $chart9 = new LaravelChart($settings9);

        $settings10 = [
            'chart_title'           => 'Bookings By Month',
            'chart_type'            => 'line',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Booking',
            'group_by_field'        => 'created_at',
        ...
        return view('home', compact('setting','customers','vans','routes','dealers','settings1', 'chart2', 'settings3', 'settings4', 'settings5', 'settings6', 'settings7', 'settings8', 'chart9', 'chart10'));
    }
}
